...
insert into `website_navigation` (`id`, `menu_name`, `parent_id`, `url`, `icon`, `order`) values('41','浏览器配置','40','/pages/browserSetting.html','icon-set','1');
insert into `website_navigation` (`id`, `menu_name`, `parent_id`, `url`, `icon`, `order`) values('42','数据库配置','40','/pages/databaseSetting.html','icon-set','2');
insert into `website_navigation` (`id`, `menu_name`, `parent_id`, `url`, `icon`, `order`) values('43','操作配置','40','/pages/operationSetting.html','icon-set','3');
insert into `website_navigation` (`id`, `menu_name`, `parent_id`, `url`, `icon`, `order`) values('44','函数配置','40','/pages/functionSetting.html','icon-set','4');
insert into `website_navigation` (`id`, `menu_name`, `parent_id`, `url`, `icon`, `order`) values('45','断言配置','40','/pages/assertionTypeSetting.html','icon-set','5');
insert into `website_navigation` (`id`, `menu_name`, `parent_id`, `url`, `icon`, `order`) values('46','全局变量配置','40','/pages/globalVarSetting.html','icon-set','6');
